            ...
            <tr className="text-[.9vmax]">
              ...
              <td className="border border-gray-300 px-[.4vmax] py-2">
                {products.map((product) => (
                  <div
                    ...
                    className="border-gray-200  bg-gray-50 flex border-2 p-2 mt-1 mb-3 "
                  >
                    <img
                      src={product.productId.imageUrl}
                      alt=""
                      className="w-[2.5vmax] h-full"
                    />
                    <div className="pl-2">
                      <p className=" m-0">
                      ...
                      <p className="m-0 ">Quantity: {product.cartQuantity}</p>
                    </div>
                  </div>
                ))}
              </td>
              <td className="border border-gray-300 px-[.4vmax] py-2">
                <button
                  ...
                  className={`mt-1 px-[.5vmax] py-1 rounded-md ${
                    isOrderCanceled || timeRemaining <= 0
